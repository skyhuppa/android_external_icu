...
import android.icu.text.DisplayOptions.NameStyle;
import android.icu.text.DisplayOptions.NounClass;
import android.icu.text.DisplayOptions.PluralCategory;
import android.icu.text.DisplayOptions.SubstituteHandling;
